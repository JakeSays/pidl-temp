...
Parser<T> ref0<T>(Parser<T> Function() function,
  [String? name]) =>
    ReferenceParser<T>(function, const [], name);
...
Parser<T> ref1<T, A1>(
  ...
  [String? name]
    ...
    ReferenceParser<T>(function, [arg1], name);
...
Parser<T> ref2<T, A1, A2>(
  ...
  [String? name]
    ...
    ReferenceParser<T>(function, [arg1, arg2], name);
...
Parser<T> ref3<T, A1, A2, A3>(
  ...
  [String? name]
    ...
    ReferenceParser<T>(function, [arg1, arg2, arg3], name);
...
Parser<T> ref4<T, A1, A2, A3, A4>(
  ...
  [String? name]
    ...
    ReferenceParser<T>(function, [arg1, arg2, arg3, arg4], name);
...
Parser<T> ref5<T, A1, A2, A3, A4, A5>(
  ...
  [String? name]
    ...
    ReferenceParser<T>(function, [arg1, arg2, arg3, arg4, arg5], name);
...
Parser<T> ref6<T, A1, A2, A3, A4, A5, A6>(
  ...
  [String? name]
    ...
    ReferenceParser<T>(function, [arg1, arg2, arg3, arg4, arg5, arg6], name);
...
Parser<T> ref7<T, A1, A2, A3, A4, A5, A6, A7>(
  ...
  [String? name]
    ...
    ReferenceParser<T>(function, [arg1, arg2, arg3, arg4, arg5, arg6, arg7], name);
...
Parser<T> ref8<T, A1, A2, A3, A4, A5, A6, A7, A8>(
  ...
  [String? name]
    ...
    ReferenceParser<T>(
        function, [arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8], name);
...
Parser<T> ref9<T, A1, A2, A3, A4, A5, A6, A7, A8, A9>(
  ...
  [String? name]
    ...
    ReferenceParser<T>(
        function, [arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9], name);
